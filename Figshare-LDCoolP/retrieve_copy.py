#Following code was developed by Reasearch Engagement at University of Arizonal Libraries UAL-RE, this code is implemented by data curation/archiving/deposition at Virginia Tech with some minor changes 
import os
import shutil
...
def download_files(article_id, fversion, fs, root_directory=None, data_directory=None,   metadata_directory=None, log=None, metadata_only=False):
    ...
    #file_list = fs.list_files(article_id,version=None)
    #file_list = fs.list_files(article_id,version=3)
