...
class ObjFormatter:
                ...
                for base, dirs, files in walk(objpath):
                    for name in files:
                        ...
                        if path.basename(filepathname) == '.DS_Store':
                            ...
                            filesize = statinfo[6]
                            csize = ObjFormatter.convert_size(size=filesize)
                            ...
                            md5sum = ObjFormatter.md5(filepathname)
                            sha3sum = ObjFormatter.sha3hash(filepathname)
    ...
    def trans_manifest(indirectory):
        """
